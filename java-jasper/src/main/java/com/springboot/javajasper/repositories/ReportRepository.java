...
import com.springboot.javajasper.entities.Entity;
...
public class ReportRepository {
	...
	public List<Object> getReport(){
		String query = "select * from aluno al inner join aluno_endereco ae on al.id_aluno = ae.aluno_end_id\r\n"
				+ "				 inner join aluno_saude als on als.aluno_id = ae.aluno_end_id\r\n"
				+ "				 inner join bairro on bairro.id_bairro = ae.ale_bairro_id\r\n"
		...
		var resultado = entityManager.createNativeQuery(query, Entity.class);
